...
default:
	...
	arm-linux-gnueabi-gcc ./build/messages.o ./build/sensors.o ./build/movement.o ./build/main.o -Wall -lrt -pthread -lm -lev3dev-c -o ./build/main


# For compiling on the robot. Not tested, might work.
robot: 
	mkdir -p ./build
	...
	gcc ./build/messages.o ./build/sensors.o ./build/movement.o ./build/main.o -Wall -lrt -pthread -lm -lev3dev-c -o ./build/main