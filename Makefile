...
default:
	...
	arm-linux-gnueabi-gcc ./build/messages.o ./build/sensors.o ./build/movement.o ./build/bt_client.o ./build/main.o -Wall -L./bt_resources -lrt -lm -lev3dev-c -lbluetooth -o ./build/main
