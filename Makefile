...
default:
	...
	#arm-linux-gnueabi-gcc -I./ev3dev-c/source/ev3 -O2 -std=gnu99 -W -Wall -Wno-comment -c ./source/tester.c -o ./build/tester.o
	...
	#arm-linux-gnueabi-gcc ./build/tester.o ./build/messages.o ./build/sensors.o ./build/movement.o ./build/main.o -Wall -lrt -lm -lev3dev-c -o ./build/main
...
robot: 
	...
	#gcc -I./ev3dev-c/source/ev3 -O2 -std=gnu99 -W -Wall -Wno-comment -c ./source/tester.c -o ./build/tester.o
	...
	#gcc ./build/messages.o  ./build/tester.o ./build/sensors.o ./build/movement.o ./build/main.o -Wall -lrt -lm -lev3dev-c -o ./build/main
