...
#define MESSAGE_HEADING 7
#define MESSAGE_SCAN_STARTED 8
#define MESSAGE_NO_CLEAR_ROUTE_FOUND 9

#define MESSAGE_ANGLE 10
#define MESSAGE_SONAR 11

#define MESSAGE_DROP 12
#define MESSAGE_DROP_COMPLETE 13
#define MESSAGE_DROP_X 14
#define MESSAGE_DROP_Y 15

#define MESSAGE_POS_X 20
#define MESSAGE_POS_Y 21

#define MESSAGE_PRINT_MAP 30
#define MESSAGE_TARGET_ANGLE 31
#define MESSAGE_TARGET_DISTANCE 32
#define MESSAGE_SEND_MAP 33
